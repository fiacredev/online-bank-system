...
if(isset($_POST['deposit'])){
    ...
    $amount_data = $_POST['amount_deposited'];
...
<body class="portal">
    ...
    <div class="profile">    
       ...
       <h4 class="text-1">here you can deposit some funds</h4>
        
       <form action="" method="POST" class="form-special">
        
        <input type="hidden" name="db_id" value="<?php echo $data['id']; ?>" >

        <label for="lname">Amount Deposited:</label>
        <input type="text" id="lname" name="amount_deposited" placeholder="Please Enter The Amount To Be Deposited"><br>

        <label for="fname">Transaction Type:</label>
        <input type="text" id="fname" name="transaction_type" value="DEPOSIT"><br>
        
        <label for="fname">Account Id:</label>
        <input type="text" id="fname" name="firstname" value="<?php echo $data['account_id']?>" disabled><br>
        
        <input type="submit" value="deposit fund" class="add-client" name="deposit" style="width: 200px;text-transform:capitalize">
