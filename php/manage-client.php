...
<body class="portal">
    ...
    <section class="manage-client">
       ...
       <h4 class="text-1">this all clients you can manage them</h4>
     ...
     ?>
      <tr>
        ...
        <!-- deal with actions of managing and deleting data in database -->

        <td><a href="update-client.php?id=<?php echo $row['id']; ?>" style="background-color:#0033cc;">update</a></td>
