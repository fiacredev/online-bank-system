...
<body class="portal">
    ...
    <section class="manage-client">
       ...
       <h4 class="text-1">this all account type you can manage them</h4>
      ...
      <tr>
        ...
        <td><a href="update-account.php?id=<?php echo $row['id']; ?>" style="background-color:#0033cc;">update</a></td>

        <td><a href="delete-account.php?id=<?php echo $row['id']; ?>">delete</a></td>
